...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (ifgreater (int 4) (int 4) (int 3) (int 2))) (int 2) "ifgreater test2")
   ;; mlet test
   ...
   (check-equal? (eval-exp (snd (apair (int 1) (apair (int 500) (int 2))))) (apair (int 500) (int 2)) "snd test1")
   ;; isaunit test
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 5)) (cons "y" (int 11))) (add (var "x") (var "y")))) (int 16) "mlet* add test")
   
   ;; ifeq test
   (check-equal? (eval-exp (ifeq (int 1) (int 2) (int 3) (int 4))) (int 4) "ifeq test1")
   (check-equal? (eval-exp (ifeq (int 10) (int 10) (int 3) (int 4))) (int 3) "ifeq test2")
